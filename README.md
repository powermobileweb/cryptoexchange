...
Bug reports and pull requests are welcome on GitHub at https://github.com/powermobileteam/cryptoexchange. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [Contributor Covenant](http://contributor-covenant.org) code of conduct.

When implementing a new exchange, refer to this [guide](https://github.com/powermobileteam/cryptoexchange/wiki/Implementing-a-New-Exchange).

The [contributing guide](https://github.com/powermobileteam/cryptoexchange/blob/master/CONTRIBUTING.md) may also be useful to you.
